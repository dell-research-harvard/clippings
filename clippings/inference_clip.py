...
if __name__ == "__main__":
    ...
    results_dict={}
    for checkpoint_path in glob.glob("/mnt/data01/clippings_general/models/clip_imwt_5bienc_clip_pretrain_labelled_m3_v3_newspapers_contrastive.pt"):
    ...
    results_df.to_csv("/mnt/data01/clippings_general/nosingle_results_check_contrastive.csv")
