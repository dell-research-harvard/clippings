...
if __name__ == "__main__":
    ...
    ###Get the embeddings
    all_embeddings, all_labels, all_text, all_paths=get_image_text_embeddings(eval_loader,clip_model,None,device,processor,"mean",1)
    ...
    ###Get the clusters
    print("Get clusters")
    clusters=cluster("SLINK",cluster_params={"min cluster size":1,"threshold":0.091,"metric":"cosine"},corpus_embeddings=all_embeddings,corpus_ids=None)
